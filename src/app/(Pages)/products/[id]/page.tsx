...
//             <div className="w-full sm:w-1/3 flex justify-center mb-6 sm:mb-0"></div>
//             <div className="flex flex-col items-center sm:items-start justify-center sm:ml-6">
//               <h3 className="text-2xl font-semibold text-gray-800 py-2 text-center sm:text-left"></h3>
//               <p className="text-gray-500 py-1 text-center sm:text-left"></p>
//               <p className="text-xl font-medium text-gray-900 py-2"></p>
//               <p className="text-sm text-gray-700 text-center sm:text-left px-4 md:w-[700px] w-full mt-4"></p>
//             </div>
//           </div>
//         }
//       >
